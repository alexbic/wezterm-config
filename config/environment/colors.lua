...
local COLORS = {
  ...
  system = "#C8A8E8",         -- пастельный фиолетовый
  ...
  dialog_hint = "#666666",             -- подсказки в диалогах (серый)
  
  -- Специфичные рамки диалогов
...
local ANSI_COLORS = {
  ...
  tip = "228",                -- пастельный желтый
  mode = "215",               -- пастельный оранжевый
