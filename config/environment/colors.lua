...
local COLORS = {
  ...
  -- === ЦВЕТА ДЛЯ ДИАЛОГОВЫХ ОКОН ===
  dialog_border = "#BD93F9",           -- основная рамка диалогов (фиолетовый)
  dialog_content = "#F8F8F2",          -- текст в диалогах (белый)
  dialog_hint = "#FFB86C",             -- подсказки в диалогах (оранжевый)
  dialog_save_border = "#50FA7B",      -- рамка диалога сохранения (зеленый)
  dialog_load_border = "#8BE9FD",      -- рамка диалога загрузки (голубой)
  dialog_delete_border = "#FF5555",    -- рамка диалога удаления (красный)  system = "#A8CCE8",     -- пастельный голубой
  ...
  -- === ЦВЕТА ДЛЯ ДИАЛОГОВЫХ ОКОН ===
  dialog_workspace_border = "#B8A8E8",    -- рамка диалога workspace (лавандовый)
  dialog_window_border = "#F9E2AF",       -- рамка диалога window (желтый)
  dialog_tab_border = "#F8A0A0",          -- рамка диалога tab (красный)
  dialog_load_border = "#98E4AA",         -- рамка диалога загрузки (зеленый)
  dialog_delete_border = "#F8A0A0",       -- рамка диалога удаления (красный)
  dialog_content = "#F8F8F2",             -- текст в диалогах (белый)
  dialog_hint = "#FFB86C",                -- подсказки в диалогах (оранжевый)  save_window_tab = "#F9E2AF",         -- желтый для window
  dialog_icon = "#B8A8E8",                 -- цвет иконки в диалоге (лавандовый)
  dialog_label = "#4ECDC4",                -- цвет меток в диалоге (бирюзовый)
  dialog_value = "#F8F8F2",                -- цвет значений в диалоге (белый)
  dialog_text = "#F8F8F2",                 -- цвет обычного текста в диалоге (белый)
  dialog_hint_text = "#888888",            -- цвет текста подсказок (серый)  save_tab_tab = "#F8A0A0",            -- красный для tab
...
local ANSI_COLORS = {
  ...
  dialog_save_border = "#50FA7B",      -- рамка диалога сохранения (зеленый)
  dialog_load_border = "#8BE9FD",      -- рамка диалога загрузки (голубой)
  dialog_delete_border = "#FF5555",    -- рамка диалога удаления (красный)  system = "152",      -- пастельный голубой
